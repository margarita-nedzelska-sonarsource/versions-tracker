...
val KOTLIN_RELEASE =
    """"KOTLIN" : {
                        ...
                        "notes" : [ "https://github.com/JetBrains/kotlin/releases/tag/v1.4.32" ]
                      }"""
...
val SCALA_META_RELEASE =
    """"SCALA_META" : {
                        ...
                        "notes" : [ "https://github.com/scalameta/scalameta/releases/tag/v4.4.14" ]
                      }"""
...
val KOTLIN_RELEASE_RECORD = """{
  ...
  "latestReleaseNote" : "https://github.com/JetBrains/kotlin/releases/tag/v1.4.32"
}"""
...
val SCALA_META_RELEASE_RECORD = """{
  ...
  "latestReleaseNote" : "https://github.com/scalameta/scalameta/releases/tag/v4.4.14"
}"""
